...
<div class="row">
        ...
        ?>
                <div class="col-12 col-md-4 col-lg-3 product-item bg-light rounded" style="border: 2px solid #a9dfef">
                        <a href="/LuCamLong_B1809478/customer/detail/detailProduct/<?php echo $arr[$i]['id'] ?>">
                                <img src="/LuCamLong_B1809478/public/img/product/<?php echo $arr[$i]['image'] ?>" alt="" width="78%" class="product-img">
